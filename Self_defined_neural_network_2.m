...
% Models
[P1,output1] = regression(n1,x_training,training_set,"logistic",0.1,500);
[P2,output2] = regression(n2,x_training,training_set,"logistic",0.1,500);
[P3,output3] = regression(n3,x_training,training_set,"logistic",0.1,500);
...
% 
% % Models 
% [P1,output1] = regression(n1,x_training,training_set,"logistic",0.1,100);
% [P2,output2] = regression(n2,x_training,training_set,"logistic",0.1,100);
% [P3,output3] = regression(n3,x_training,training_set,"logistic",0.1,100);
...
% % 
% % % Models 
% [P1,output1] = regression(n1,x_training,training_set,"relu",0.01,300);
% [P2,output2] = regression(n2,x_training,training_set,"relu",0.01,300);
% [P3,output3] = regression(n3,x_training,training_set,"relu",0.001,3000);
