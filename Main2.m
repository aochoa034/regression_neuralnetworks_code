...
[P1,net1,tr1] = matlab_NN(n1,x_training,training_set,"logistic");
[P2,net2,tr2] = matlab_NN(n2,x_training,training_set,"logistic");
[P3,net3,tr3] = matlab_NN(n3,x_training,training_set,"logistic");


% %%% TAKE NOW h=0.4 AT THE BEGGINING %%%%
% %%%%%%%%%%% EXAMPLE 2 %%%%%%%%%%%%%
% n1 = 4; n2 = 6; n3 = 13;
% 
% [P1,net1,tr1] = matlab_NN(n1,x_training,training_set,"logistic");
